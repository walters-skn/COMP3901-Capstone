...
INSERT INTO reminders(patient_id, clinic_id, medication_id, location, appt_date, appt_time, remind_type, remind_desc)VALUES(1, 1, 'Angels Health Care AMDG', '21-07-23', '06:00:00', 'appointment', 'patient has appointment at 6am');
INSERT INTO reminders(patient_id, clinic_id, medication_id, location, appt_date, appt_time, remind_type, remind_desc)VALUES(2, 3, 2, NULL, NULL, NULL, 'medication', 'patient has meds to take at 2pm');
...
INSERT INTO clinics (name, type, address, parish) VALUES ('St Jago Park Health Center (SERHA)', 'Public', ' Burke Road, Spanish Town St. Catherine', 'St. Catherine');
INSERT INTO clinics (name, type, address, parish) VALUES ('Andrews Memorial Seventh-Day Adventist Hospital', 'Private', '27 Hope Rd, Kingston', 'Kingston');
INSERT INTO clinics (name, type, address, parish) VALUES ('Medical Associates', 'Private', '18, 10 Tangerine Pl, Kingston', 'Kingston');
INSERT INTO clinics (name, type, address, parish) VALUES ('Kingston Public Hospital (K.P.H.)', 'Public', 'North St, Kingston', 'Kingston');
INSERT INTO clinics (name, type, address, parish) VALUES ('Trinity Mall Medical Centre', 'Private', '3 Barnett St, Montego Bay', 'St. James');
INSERT INTO clinics (name, type, address, parish) VALUES ('Sekhmet Medical Center', 'Private', 'Shop 14, Bogue City Center, Bogue Rd, Montego Bay', 'St. James');
INSERT INTO clinics (name, type, address, parish) VALUES ('Cornwall Regional Hospital', 'Public', 'Montego Bay, St James', 'St. James');
